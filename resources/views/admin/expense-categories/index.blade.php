@extends('layouts.admin', ['heading' => 'Expense Categories'])

@section('title', 'Expense Categories')

@section('content')
    <x-ui.page-header title="Expense Categories" subtitle="Organize expenses for reporting and filtering">
        <x-slot:actions>
    ...
    <x-admin.filter-bar class="mb-4">
        <form action="{{ route('admin.expense-categories.index') }}" method="GET" class="sg-filter-grid">
            ...
            <x-admin.filter-field label="Actions" class="sg-filter-actions-field">
                <div class="sg-filter-actions">
                    ...
                    <a href="{{ route('admin.expense-categories.index') }}" class="btn btn-light">Reset</a>
                </div>
            </x-admin.filter-field>
        </form>
    </x-admin.filter-bar>
                        ...
                        @forelse ($categories as $category)
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <x-admin.expense-category-actions :category="$category" />
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    <div class="sg-empty-state">
                                        <h3 class="h6 mb-1">No expense categories found</h3>
